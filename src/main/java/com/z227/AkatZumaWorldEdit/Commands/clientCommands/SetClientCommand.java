...
//
//            System.out.println("getDescriptionId:" + blockInput.getState().getBlock().getDescriptionId());
//            System.out.println("getNamespace:" + blockInput.getState().getBlock().getLootTable().getNamespace());
//            System.out.println(AkatZumaWorldEdit.ConfigMap);
//
//        }else{
