...
public class LanguageDataGenerator {
    ...
    public static class ChineseLanguageProvider extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add("chat.akatzuma.error.no_copy_map", "§c 没有找到复制的内容，请先使用§d /// copy §f指令创建一个");
            ...
            this.add("chat.akatzuma.success.flip", "§a 已翻转复制的选区内容，使用§d /// paste §f粘帖");
            this.add("chat.akatzuma.success.paste", "§a 粘帖成功，可以使用§d/// undo§f指令撤销操作");
            this.add("chat.akatzuma.success.stack", "§a 堆叠成功，可以使用§d/// undo§f指令撤销操作");
            ...
            this.add("chat.akatzuma.undo.tip", ",可以使用§d/// undo§f指令撤销操作");
